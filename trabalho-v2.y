...
cmd : 	  id                {$$ = registerVal($1);}
		| id EQUAL id       { updateRegisterVal($1, registerVal($3)); }       	/* send register value in $3 to register $1 */
        | INC AP id FP      { updateRegisterVal($3, ((registerVal($3)) + 1)); }	/* send register value in $3 to register $1 added 1 */
